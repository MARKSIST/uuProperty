const Lsi = {
  appName: {
    cs: "Aplikace uuProperty",
    en: "Application uuProperty",
  },
  ...
  about: {
    header: {
      cs: "O aplikaci uuProperty",
      en: "About application uuProperty",
    },
    creatorsHeader: {
      cs: "Tvůrci aplikace",
  ...
  unauthInit: {
    buyYourOwn: {
      cs: "Můžete si koupit vlastní uuProperty.",
      en: "You can buy your own uuProperty.",
    },
    notAuthorized: {
      cs: "Nemáte právo inicializovat tuto aplikaci uuProperty.",
      en: "You don't have rights to initialize this uuProperty.",
    },
  },
